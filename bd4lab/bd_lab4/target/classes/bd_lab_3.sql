...
DROP TABLE IF EXISTS `mydb`.`intervalOfUpdates`;
...
-- -----------------------------------------------------
-- Table `mydb`.`intervalOfUpdates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`intervalOfUpdates`
(
    `id`            INT         NOT NULL AUTO_INCREMENT,
...
ALTER TABLE meteostation
    ADD CONSTRAINT meteostation_data_id FOREIGN KEY meteostation_data_id (data_id)
        REFERENCES data (id);

ALTER TABLE meteostation
    ADD CONSTRAINT meteostation_interval_of_updates_id FOREIGN KEY meteostation_interval_of_updates_id (interval_of_updates_id)
        REFERENCES interval_of_updates (id);

ALTER TABLE meteostation
    ADD CONSTRAINT meteostation_location_id FOREIGN KEY meteostation_location_id (location_id)
        REFERENCES location (id);

ALTER TABLE meteostation
    ADD CONSTRAINT meteostation_service_work_id FOREIGN KEY meteostation_service_work_id (service_work_id)
        REFERENCES service_work (id);

ALTER TABLE meteostation
    ADD CONSTRAINT data FOREIGN KEY meteostation_developer_id (developer_id)
        REFERENCES intervalOfUpdates (id);

ALTER TABLE `data`
    ADD CONSTRAINT data_interval_of_updates_id FOREIGN KEY data_interval_of_updates_id (interval_of_updates_id)
        REFERENCES interval_of_updates (id);
...
ALTER TABLE location
    ADD CONSTRAINT location_adress_id FOREIGN KEY location_adress_id (adress_id)
        REFERENCES adress (id);

ALTER TABLE location
    ADD CONSTRAINT location_gps_id FOREIGN KEY location_gps_id (gps_id)
        REFERENCES gps (id);

INSERT INTO interval_of_updates (`id`, `interval`)
VALUES ("1", "1"),
       ("2", "2"),
       ("3", "3"),
       ("4", "4"),
...
INSERT INTO adress (`id`, `adress`, `street`, `build`)
VALUES ("1", "None", "Kopernika 1", "SC Vesna"),
...
INSERT INTO data (`id`, `temperature`, `humidity`, `wind_speed`, `atmospheric_pressure`, `wind_direction`,
                  `interval_of_updates_id`)
...
INSERT INTO intervalOfUpdates (`id`, `name`, `surname`, `telephone_num`)
VALUES ("1", "Ivan", "Voloshanskyi", "0980000000"),
...
INSERT INTO gps (`id`, `latitude`, `longtitude`)
VALUES ("1", "1", "1"),
       ("2", "2", "2"),
       ("3", "3", "3"),
       ("4", "4", "4"),
...
INSERT INTO location (`city`, `adress_id`, `gps_id`)
VALUES ("Sambir", "1", "1"),
       ("Lviv", "2", "2"),
       ("Drohobych", "3", "3"),
       ("Ivano-Frankivsk", "4", "4"),
...
INSERT INTO service_work (`id`, `date`, `description`)
VALUES ("1", "2000-10-01", "Removed meteostation"),
...
INSERT INTO meteostation (`id`, `installation_date`, `data_id`, `interval_of_updates_id`, `location_id`,
                          `service_work_id`, `developer_id`)
VALUES ("1", "2000-10-01", "1", "1", "1", "1", "1"),
