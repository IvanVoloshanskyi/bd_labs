...
CREATE SCHEMA IF NOT EXISTS `meteostation` DEFAULT CHARACTER SET utf8 ;
USE `meteostation` ;
SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `meteostation`.`adress` ;
DROP TABLE IF EXISTS `meteostation`.`data` ;
DROP TABLE IF EXISTS `meteostation`.`developer` ;
DROP TABLE IF EXISTS `meteostation`.`gps` ;
DROP TABLE IF EXISTS `meteostation`.`interval_of_updates` ;
DROP TABLE IF EXISTS `meteostation`.`meteostation` ;
DROP TABLE IF EXISTS `meteostation`.`service_work` ;
DROP TABLE IF EXISTS `meteostation`.`location` ;
SET FOREIGN_KEY_CHECKS=1;

-- -----------------------------------------------------
-- Table `mydb`.`interval_of_updates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`interval_of_updates` (
...
-- Table `mydb`.`data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`data` (
                                                     `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `mydb`.`adress`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`adress` (
                                                       `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `mydb`.`gps`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`gps` (
                                                    `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `mydb`.`location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`location` (
                                                         `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`service_work` (
                                                             `id` INT NOT NULL AUTO_INCREMENT,
                                                             `date` DATE NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`developer` (
                                                          `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meteostation`.`meteostation` (
                                                             `id` INT NOT NULL AUTO_INCREMENT,
